          ...
          <p className="w-[650px] text-slate-400">
            ...
            ** At Gabselina School, <br />
            ...
            <span className="text-white">
              ...
              confident in their abilities, grounded in strong moral values, and
            ...
            <span className="text-white">
              ...
              mentorship, and specially designed programs, we instill values
              that shape our students into compassionate leaders and responsible
              citizens.
            </span>
            <br />
            <br />
            ...
            ** We provide a rigorous academic curriculum that challenges
            ...
            <span className="text-white">
              ...
              curiosity, critical thinking, and a love for learning. We equip
              our students with the tools they need to succeed in any path they
            ...
            ** We believe that true independence comes from a deep connection to
            God.{" "}
            <span className="text-white">
              At Gabselina, spiritual development is interwoven into the fabric
              of our school culture. We encourage students to explore their
              faith, understand their purpose, and rely on God as their ultimate
              guide.
            </span>{" "}
